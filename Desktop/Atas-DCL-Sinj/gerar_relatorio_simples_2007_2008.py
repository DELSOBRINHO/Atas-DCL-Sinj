...
# -*- coding: utf-8 -*-
"""
GERAR RELATÓRIO SIMPLES - 2007 + JAN-FEV 2008
==============================================

Gera relatório dos 327 DCLs baixados sem OCR

Uso:
    python gerar_relatorio_simples_2007_2008.py
...
ARQUIVO_SAIDA_JSON = Path(f"C:/Users/{USUARIO}/Desktop/Atas-DCL-Sinj/relatorio_dcls_2007_2008.json")
ARQUIVO_SAIDA_XLSX = Path(f"C:/Users/{USUARIO}/Desktop/Atas-DCL-Sinj/relatorio_dcls_2007_2008.xlsx")
...
def carregar_links():
    ...
    if not ARQUIVO_LINKS.exists():
        print(f"⚠️  Arquivo de links não encontrado: {ARQUIVO_LINKS}")
        return {}
...
def gerar_relatorio():
    """Gera relatório dos DCLs"""
    print("\n" + "="*70)
    print("GERAR RELATÓRIO SIMPLES - 2007 + JAN-FEV 2008")
    print("="*70)
    ...
    # Listar apenas os 327 novos PDFs
    ...
    print(f"✅ {len(arquivos_pdf)} PDFs novos encontrados")
    ...
    for i, arquivo in enumerate(arquivos_pdf, 1):
        ...
        if i % 50 == 0:
            print(f"[{i:3d}/{len(arquivos_pdf)}] ✅ Processados")
    
    print(f"[{len(arquivos_pdf):3d}/{len(arquivos_pdf)}] ✅ Processados")
