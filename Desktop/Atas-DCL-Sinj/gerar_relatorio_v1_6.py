...
# Criar workbook para v1.6
print("📊 Criando relatório v1.6...")
...
atas_sorted = sorted(atas, key=lambda x: (x['tipo_sessao'], int(x['sessao_num'])))
...
# Salvar arquivo versionado v1.6
version = "v1.6"
...
wb.save(output_path)
print(f'✅ Relatório v1.6 gerado: {output_filename}')
print(f'Total de atas: {len(atas)}')
print(f'Correções v2:')
print(f'  - Marcadores expandidos para encerramento')
print(f'  - Busca até última ocorrência de encerramento')
print(f'  - 90 páginas finais atualizadas')
