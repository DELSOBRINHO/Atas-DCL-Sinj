...
# -*- coding: utf-8 -*-
"""
PROCESSAR DCLs COM OCR - VERSÃO SIMPLES (SEQUENCIAL)
=====================================================

Processa 327 DCLs para extrair texto e metadados usando OCR

Uso:
    python processar_ocr_simples_2007_2008.py
...
def main():
    """Função principal"""
    print("\n" + "="*70)
    print("PROCESSAR DCLs COM OCR - 2007 + JAN-FEV 2008 (VERSÃO SIMPLES)")
    print("="*70)
