...
# -*- coding: utf-8 -*-
"""
RELATÓRIO FINAL - 346 DCLs ÚNICOS
==================================

Gera relatório final dos 346 DCLs únicos após limpeza de duplicatas

Uso:
    python relatorio_final_346_dcls.py
...
ARQUIVO_SAIDA_JSON = Path(f"C:/Users/{USUARIO}/Desktop/Atas-DCL-Sinj/relatorio_final_346_dcls.json")
ARQUIVO_SAIDA_XLSX = Path(f"C:/Users/{USUARIO}/Desktop/Atas-DCL-Sinj/relatorio_final_346_dcls.xlsx")
...
def main():
    """Função principal"""
    print("\n" + "="*70)
    print("RELATÓRIO FINAL - 346 DCLs ÚNICOS")
    print("="*70)
